 ...
 * - Validate read buffer
 */
TEST_F(TestMux, user_rx_invalid_fcs)
{
    ...
    /* Validate proper callback callcount. */
    EXPECT_EQ(0, m_user_rx_invalid_fcs_check_value);
    ...
    /* Validate proper callback callcount. */
    EXPECT_EQ(1, m_user_rx_invalid_fcs_check_value);
 ...
 * - Validate read buffer
 */
TEST_F(TestMux, rx_frame_type_not_supported)
{
    ...
    /* Validate proper callback callcount. */
    EXPECT_EQ(0, m_rx_frame_type_not_supported_check_value);
    ...
    /* Validate proper callback callcount. */
    EXPECT_EQ(1, m_rx_frame_type_not_supported_check_value);
 ...
 */
TEST_F(TestMux, rx_frame_type_ua_when_no_sabm_send)
{
    InSequence dummy;
 ...
 * - Validate DLCI establishment
 */
TEST_F(TestMux, rx_frame_type_dm_when_no_sabm_send)
{
    InSequence dummy;
 ...
 * - Validate DLCI establishment
 */
TEST_F(TestMux, rx_frame_type_ua_invalid_cr_and_pf_bit)
{
    InSequence dummy;
 ...
 * - Valid Rx frame type DM received: starts expected processing within implementation
 */
TEST_F(TestMux, rx_frame_type_dm_invalid_cr_and_pf_bit)
{
    InSequence dummy;
    ...
    peer_iniated_request_rx_full_frame_tx(READ_FLAG_SEQUENCE_OCTET, STRIP_FLAG_FIELD_NO,
                                          &(read_byte_mux_open[0]), sizeof(read_byte_mux_open),
                                          &(write_byte_channel_open[0]), sizeof(write_byte_channel_open),
                                          CANCEL_TIMER_YES, START_TIMER_YES, fh_mock, sig_io);
 ...
 * - As specified above
 */
TEST_F(TestMux, rx_frame_type_disc_invalid_cr_and_pf_bit)
{
    InSequence dummy;
 ...
 * - As specified above
 */
TEST_F(TestMux, rx_frame_type_ua_dlci_id_mismatch)
{
    InSequence dummy;
